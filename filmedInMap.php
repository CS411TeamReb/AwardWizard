  	...
  	map.controls[google.maps.ControlPosition.BOTTOM_LEFT].push(englandControlDiv);
		...
		$.ajax({
			...
			success: function(filmedIn) {
				...
				alert("Welcome to the Filmed Locations Map! \nEach pin on this map represents a movie, tv show, or stage, and is placed on the location where the work was filmed. The yellow pins mean that the work won an award, while the grey pins means that the work was nominated, but did not win. Click on a marker to view more information about the work and the award for which it was nominated or won.");
			} 
		});
